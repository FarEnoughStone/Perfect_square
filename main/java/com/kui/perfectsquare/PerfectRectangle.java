...
public class PerfectRectangle extends Activity implements View.OnTouchListener{
    ...
    int lastY;
    int a=9;
    int mindx=10,boxw=660,boxh=640;
    ImageView imageViews[] = new ImageView[a];
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.perfectrectangle);
        ...
        for(;a-->0;) {
            ...
            view.setMinimumWidth(w[a]*20);
            view.setMinimumHeight(w[a]*20);
            view.setOnTouchListener(this);
            view.setClickable(true);
            view.setId(View.generateViewId());
            RelativeLayout.LayoutParams lp1 = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.WRAP_CONTENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
            if (a > 2) {
                lp1.leftMargin = x + 100 * (a - 3);
                lp1.topMargin = y;
            } else {
                lp1.leftMargin = x + 100 * a;
                lp1.topMargin = y + 400;
            }
            imageViews[a]=view;
